                ...
                <div className="row">
                    ...
                    <div className="row m-0 bg-light">
                        <div className="col-md-4 col-6 ps-30 pe-0 my-4">
                            ...
                            <p className="h5">25000<span class="ps-1">Km</span></p>
                        </div>
                ...
                <div className="row m-0">
                    <div className="col-12 px-4">
                        <div className="d-flex align-items-end mt-4 mb-2">
                            <p className="font4 m-0"><span className="pe-1">ZAZ</span><span className="pe-1">966</span><span
                    ...
                    <div className="col-12 px-0">
                            ...
                            <div className="col-12 px-4">
                                <div className="d-flex  mb-4">
                                    <span className="">
                                        ...
                                        <input className="form-control1" type="text" value="4485 6888 2359 1498"
                                ...
                                <div className="d-flex mb-5">
                                    <span className="me-5">
                                        ...
                                        <input className="form-control1" type="text" value="David J.Frias"
                                            placeholder="Name"/>
                                    </span>
                                    <div className="w-100 d-flex flex-column align-items-end">
                        ...
                        <div className="row m-0">
                            <div className="col-12  mb-4 p-0">
                                <div className="btn btn-primary">Purchase<span class="fas fa-arrow-right ps-2"></span>
                                </div>
                            </div>
                        </div>
                    </div>
