        ...
        <div className="blog-container">
         ...
         <div className="blog">
                <div className="single-blog shadow">
                    ...
                    <h4>Maruti YFG (Skoda Kushaq/VW Taigun Rival) to Launch Soon</h4>
                    <p>
                ...
                <div className="single-blog shadow">
                    ...
                    <h4>Best Hyundai Automatic SUV Cars</h4>
                    <p>
                ...
                <div className="single-blog shadow">
                    ...
                    <h4>New Hyundai Venue Adopts Sensuous Sportiness Theme for Bold Outlook</h4>
                    <p>
